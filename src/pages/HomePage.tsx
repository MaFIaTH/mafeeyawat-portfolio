    ...
    return (
        <main className="min-h-screen min-w-screen bg-gray bg-cover">
            <div className="text-center py-20 px-10">
                <img src={ProfilePicture} className="min-w-1/8 max-w-1/4 mx-auto pb-10" alt="Hotpot" />
                <h2 className="max-sm:text-3xl text-5xl font-bold text-white italic" >{fullName}</h2>
